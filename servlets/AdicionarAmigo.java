...
public class AdicionarAmigo extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try{
			...
			if(blockUser != null){
				friendFacade.undoFriendship(otherUser, centralFacade.getLoggedUser());
				request.setAttribute("amizaderemovida", "true");
			}
			else{
				friendFacade.addFriend(otherUser, centralFacade.getLoggedUser());
				request.setAttribute("solicitacaoenviada","true");
			}

			goToPage("/userDetails.jsp?userID="+otherUser, request, response);
