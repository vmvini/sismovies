...
public class AvaliarFilme extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try{
			...
			//String rate, String movieID, String meID, String comment
			rateFacade.doRate(stars, movieID, meID, comment );

			request.setAttribute("avaliacaofeita","true");
